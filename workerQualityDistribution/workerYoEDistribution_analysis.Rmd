...
colnames(dt)<-c("years_of_experience");
summary(dt);

#clean-up NA's

title<- paste("Fig.1 - Distribution of years of experience");
ggplot(dt,,aes(x=YoE))+
  geom_histogram(binwidth = 0.2) +
  ggtitle(title) +
  theme(plot.title = element_text(size = fontSize))+
  labs(y="number of workers", x=paste(yearsOfExperience,"years of experience"));
