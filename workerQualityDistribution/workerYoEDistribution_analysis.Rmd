...
countScoreLevel<- function(startYear, endYear){
...
<p> Therefore, in order to investigate the distribute of years of experience across questions, I selected the following four intervals: from 1 to 5 years of experince
