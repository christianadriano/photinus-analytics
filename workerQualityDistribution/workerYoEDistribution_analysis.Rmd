...
title<- paste("Fig.1 - Years of experience between ",startYear," and ", endYear);
p1<-ggplot(dt,aes(x=yearCount))+
  geom_histogram(binwidth = 0.2) +
  ggtitle(title) +
  theme(plot.title = element_text(size = fontSize))+
  labs(y="question count", x="years of experience");

startYear<-2;
endYear<-5;
dt<-countYoE(dataf,startYear,endYear);
title<- paste("Fig.2 - Years of experience between ",startYear," and ", endYear);
...
endYear<-10;
dt<-countYoE(dataf,startYear,endYear);
title<- paste("Fig.3 - Years of experience between ",startYear," and ", endYear);
...
endYear<-51;
dt<-countYoE(dataf,startYear,endYear);
title<- paste("Fig.4 - Years of experience between ",startYear," and ", endYear);
