...
title<- paste("Fig.1 - Distribution of ",profession," workers across questions");
...
dt<-countItem(dataf,profession);
title<- paste("Fig.2 - Distribution of ",profession," workers across questions");
...
profession<-"Hobbyist";
dt<-countItem(dataf,profession);
title<- paste("Fig.3 - Distribution of ",profession," workers across questions");
...
dt<-countItem(dataf,profession);
title<- paste("Fig.4 - Distribution of ",profession," workers across questions");
...
profession<-"Other";
dt<-countItem(dataf,profession);
title<- paste("Fig.5 - Distribution of ",profession," workers across questions");
...
<p>Charts show that workers are not uniformly distributed across questions, for instance, up to 10 questions received 7 out of 20 answers from undergraduate students (Fig.4). Since undergraduates have the lowest level of answer accuracy, these questions might have been overlooked. </p>
